...
// Basic tests
inline std::vector<TestCase> get_basic_tests() {
    return {
...
inline std::vector<TestCase> get_release_selection_tests() {
    return {
...
// no release given
inline std::vector<TestCase> get_no_release_tests() {
    return {
...
// obscure releases
inline std::vector<TestCase> get_obscure_release_tests() {
    return {
...
// obscure recordings
inline std::vector<TestCase> get_obscure_recording_tests() {
    return {
...
// special characters
inline std::vector<TestCase> get_special_character_tests() {
    return {
         ...
         { "!!!","!!!","KooKooKa Fuk‐U","f26c72d3-e52c-467b-b651-679c73d8e1a7","1b105601-d2d3-4da2-a7d9-114f981b1766","5c811d80-2743-461a-a163-82e14382aad7" },
...
// artist credits / artist aliases
inline std::vector<TestCase> get_artist_credit_tests() {
    return {
...
inline std::vector<TestCase> get_non_album_recording_tests() {
    return {
         { "darkseed","","entre dos tierras","8b0ab1c4-ffe4-491e-adda-037c744d1b00","","c7ba26e3-66c9-40a7-af72-cd27cdeed09c" }
    };
}
 
// Avoid most popular matches
inline std::vector<TestCase> get_avoid_popular_match_tests() {
    return {
...
// Avoid punctuation
inline std::vector<TestCase> get_punctuation_tests() {
    return {
...
// second best release match
inline std::vector<TestCase> get_second_best_release_tests() {
    return {
...
// Fuzzy release search
inline std::vector<TestCase> get_fuzzy_release_tests() {
    return {
...
// Heavily overloaded artist names
inline std::vector<TestCase> get_overloaded_artist_tests() {
    return {
